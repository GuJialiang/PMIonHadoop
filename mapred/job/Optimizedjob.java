...
public class Optimizedjob extends Job {
    ...
    //private Class<KeyValueTextInputFormat> inputFormatClass = null;
	
    private Integer flag= null;//set to 1 when use KeyValueInputFormat
    ...
    public Optimizedjob(Configuration conf, String input, String output,
			Integer flag,String jobName) throws IOException {
		super(conf);
...
/*
    	public Optimizedjob(Configuration conf, String input, String output,
			Class<KeyValueTextInputFormat> customedInputFormatClass,String jobName) throws IOException {
		super(conf);
		...
		reduceJobs = 0; // Initalizing to 0 means equal to number of maximum
						// reducers
	    inputFormatClass = customedInputFormatClass;
	}
*/
...
/**
	...
	private void setup() throws IOException {
		...
		for (String input : inputs){
			if(flag != null)
                KeyValueTextInputFormat.addInputPath(this, new Path(input));
            else
